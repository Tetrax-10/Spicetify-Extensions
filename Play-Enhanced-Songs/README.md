...
Step 3 : Search `Play Enhanced Songs` Click Install Buttton. Done!

<br />

## Install Manually

Copy `playEnhancedSongs.js` into your [Spicetify](https://github.com/spicetify/spicetify-cli) extensions directory:
| **Platform** | **Path** |
|------------|-----------------------------------------------------------------------------------|
...
```
spicetify config extensions playEnhancedSongs.js
spicetify apply
```
