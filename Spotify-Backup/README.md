...
Step 3 : Search `Spotify Backup` Click Install Buttton. Done!

<br />

## Install Manually

Copy `spotifyBackup.js` into your [Spicetify](https://github.com/spicetify/spicetify-cli) extensions directory:
| **Platform** | **Path** |
|------------|-----------------------------------------------------------------------------------|
